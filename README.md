...
Complete web application to be used as a forum mainly focused around Java. To have some similarities with the Telerik
Academy forum.
...
```
cd existing_repo
git remote add origin https://gitlab.com/tddv/javaforum.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tddv/javaforum/-/settings/integrations)
