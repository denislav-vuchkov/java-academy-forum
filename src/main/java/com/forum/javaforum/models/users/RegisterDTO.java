...
public class RegisterDTO implements UserDTOIn {
    ...
    public RegisterDTO(String username, String first_Name, String lastName,
                     String password, String passwordConfirm, String email, String phoneNumber) {
